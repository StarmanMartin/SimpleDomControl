"""
URL configuration for SdcTest project.
...
def index(request):
    return render(request, 'index.html', {'VERSION': settings.VERSION, 'debug': settings.DEBUG,
                                          'server_call_via_web_socket': settings.SERVER_CALL_VIA_WEB_SOCKET})
