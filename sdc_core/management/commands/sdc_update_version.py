...
from sdc_core.management.commands.init_add.utils import convert_to_tag_name, copy
            ...
            if os.path.exists(sdc_js_outer_dir):
                ...
                for file in os.listdir(sdc_js_dir):
                    ...
                    if os.path.isdir(old_js_file):
                        ...
                        add_sdc_core = AddControllerManager(app_name, controller_name_sc)
                        add_sdc_core.add_to_organizer(include_css)
