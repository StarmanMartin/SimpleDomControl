...
from sdc_manager.management.commands.init_add.add_model_manager import AddModelManager

from sdc_manager.management.commands.init_add import options, settings_manager
from sdc_manager.management.commands.sdc_link_html import make_model_link
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **ops):
        ...
        add_sdc_manager = AddModelManager(app_name, model_name)


        add_sdc_manager.add_model()
        add_sdc_manager.add_model_form()
        add_sdc_manager.add_model_template()
