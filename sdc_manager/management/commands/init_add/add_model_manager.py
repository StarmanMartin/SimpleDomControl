...
from sdc_manager.management.commands.init_add.utils import copy
...
class AddModelManager():
    ...
    def _check_if_sdcmodel_imported(self, file_path):
        ...
        data = ""
        new_url_line = 'from sdc_tools.sdc_extentions.models import SdcModel\nfrom sdc_tools.sdc_extentions.forms import AbstractSearchForm\nfrom django.template.loader import render_to_string\nfrom sdc_tools.sdc_extentions.search import handle_search_form'.format(
            self.reps['§PROJECT§'])
